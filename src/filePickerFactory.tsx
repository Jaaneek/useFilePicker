...
import { UseFilePickerConfig, FileContent, FilePickerReturnTypes, FileError, ReaderMethod, FactoryConfig } from './interfaces';
...
export const filePickerFactory = ({ pickDirectories }: FactoryConfig) => {
  const useFilePicker = ({
    accept = '*',
    multiple = true,
    readAs = 'Text',
    ...
    const openFileSelector = () => {
      ...
      openFileDialog(fileExtensions, multiple, pickDirectories, evt => {
        clear();
