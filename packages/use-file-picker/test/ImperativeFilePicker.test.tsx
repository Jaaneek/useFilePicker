...
import { invokeUseImperativeFilePicker, isInputElement } from './testUtils.js';
import { describe, expect, it } from 'vitest';
import { ImperativeFilePickerComponent } from './FilePickerTestComponents.jsx';

describe('DefaultPicker', () => {
  it('renders without crashing', async () => {
    const { findByRole } = render(<ImperativeFilePickerComponent />);
